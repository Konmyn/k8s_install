...
ansible ${HOST4} -m shell -a "poweroff"
...
ansible ${HOST3} -m shell -a "poweroff"
...
ansible ${HOST2} -m shell -a "poweroff"
...
ansible ${HOST1} -m shell -a "poweroff"
...
ansible ${HOST0} -m shell -a "poweroff"
